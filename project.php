    ...
    <div class="gallery_area">
            ...
            <div class="gallery_nav">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <h3 class="gallery_title">Eche un vistazo a algunos de nuestros<br>
                            increíbles proyectos</h3>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="portfolio-menu">
                          <!--<button class="active" data-filter="*">Todos</button>
                            <button data-filter=".cat1">Arquitectura</button>
                            <button data-filter=".cat2">Construcción</button>
                            <button data-filter=".cat3">Pladur</button>-->
                            <button class="active" data-filter="*">Todos</button>
                            <button data-filter=".Old">Proyectos finalizados</button>
                            <button data-filter=".New">Proyectos en proceso</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid p-0">
            ...
            <?php foreach($dir_contents as $file): ?>
                 ...
                 <?php list($service, $type) = explode('-', $file);  ?>
                    <div class="col-xl-3 col-lg-3 col-md-6 grid-item <?php echo $type ?>">
                        <div class="single_gallery">
                                ...
                                <div class="gallery_hover">
                                    <div class="hover_inner d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="icon">
                                            <a href="project_details.php?service=<?php echo $service ?>"><i class="ti-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                        </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-6 col-md-8">
                    <div class="chose_info">
                        ...
                        <p class="lasrge_text">
                            Grupo RG es una empresa de construcción de servicio completo que ofrece soluciones de construcción de principio a fin.
                        </p>
                        <p>Más de 20 años de experiencia nos avalan en el sector de la construcción en Baleares. 
                        Con el paso de los años, hemos conseguido posicionarnos como líderes en el sector de la construcción 
                        gracias al reconocimiento de la calidad de nuestros trabajos. Nos dedicamos íntegramente a las construcciones,
                        reformas, pladur y creaciones de obras nuevas de lujo en Mallorca.</p>
